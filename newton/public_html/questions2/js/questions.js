...
var questions = [
	{
		q:"Newton's second law of motion states that acceleration is calculated as: &blank&",
		c: ["force multiplied by mass", "force divided by mass"],
		a: 0
	},
	{
		q:"If you double the amount of force on an object with the same mass, the acceleration &blank&",
		c: ["triples", "doubles", "stays the same"],
		a: 1
	},
	{
	...
	{
		q: "If mass increases, then acceleration will &blank&?",
		c: ["increase", "stay the same", "decrease"],
		a: 2
	},
	{
		q: "Using F = ma, if the mass of a beach ball is 20 kg and it is thrown in the air with an acceleration of 10 m/s, calculate the force on the beach ball. &blank&",
		c: ["100 N", "300 N", "200 N"],
		a: 2
	},
	{
		q: "What variable is shown on the x-axis and y-axis on the graph? &blank& <br><br><img src=graph.jpg> ",
		c: ["x-axis = time and y-axis = distance", "x-axis = distance and y-axis = time "],
		a: 0
	},
		{
		q: "Velocity is distance / time, it shows how fast an object is over time. What is the velocity when the time is 6 seconds using the graph below? &blank& <br><br><img src=graph.jpg>", 
		c: ["6/7 = 0.85 m/s", "7/6 = 1.2 m/s"],
		a: 1
	},
	{
		q: "Velocity is distance / time, it shows how fast an object is over time. What is the velocity at 5 seconds? &blank& <br><br><img src=graph.jpg>",
		c: ["7/5 = 1.4 m/s", "5/7= .71 m/s"],
		a: 0
	},
	{
		q: "What do you notice is happening to the velocity between 0 and 5 seconds using the graph below? &blank& <br><br><img src=graph.jpg>",
		c: ["The velocity is increasing", "The velocity is decreasing", "The velocity does not change"],
		a: 0
	},
